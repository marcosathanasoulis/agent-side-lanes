...
class InstallerTests(unittest.TestCase):
    ...
    def test_install_check_uninstall_are_reversible(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            destinations = (
                ...
                home / ".agents/skills/claude-side-lane",
                home / ".claude/skills/codex-side-lane",
            )
    ...
    def test_install_preserves_unrelated_destination(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertFalse((home / ".agents/skills/claude-side-lane").exists())
            self.assertFalse((home / ".claude/skills/codex-side-lane").exists())
    ...
    def test_host_selective_install_and_uninstall_share_runner(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            codex_skill = home / ".agents/skills/claude-side-lane"
            claude_skill = home / ".claude/skills/codex-side-lane"
